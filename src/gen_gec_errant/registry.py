...
MODEL_REGISTRY: Dict[str, ModelConfig] = {
    ...
    "gpt2-medium-native": ModelConfig(
        name="gpt2-medium-native",
        params="355M",
        ...
        batch_size=8,
        gec_batch_size=32,
        description="GPT-2 Medium native (zero-shot baseline; matched control for ft-gpt2-medium)",
    ),
    "gpt2-large-native": ModelConfig(
        name="gpt2-large-native",
        params="774M",
        ...
        batch_size=4,
        gec_batch_size=16,
        description="GPT-2 Large native (zero-shot baseline; matched control for ft-gpt2-large)",
    ),
    # ── GPT-2 fine-tuned ──
    ...
    "ft-pythia-70m": ModelConfig(
        ...
        checkpoint_subdir="best/checkpoint-13497",
        is_learner_tuned=True,
        batch_size=16,
        gec_batch_size=32,
        description="Pythia 70M fine-tuned on EFCAMDAT all-data",
    ),
    "pythia-70m-native": ModelConfig(
        name="pythia-70m-native",
        params="70M",
        ...
        batch_size=16,
        gec_batch_size=32,
        description="pythia-70m native (zero-shot baseline; matched control for ft-pythia-70m)",
    ),
    ...
    "ft-pythia-160m": ModelConfig(
        ...
        checkpoint_subdir="best/checkpoint-15951",
        is_learner_tuned=True,
        batch_size=16,
        gec_batch_size=32,
        description="Pythia 160M fine-tuned on EFCAMDAT all-data",
    ),
    "pythia-160m-native": ModelConfig(
        name="pythia-160m-native",
        params="160M",
        ...
        batch_size=16,
        gec_batch_size=32,
        description="pythia-160m native (zero-shot baseline; matched control for ft-pythia-160m)",
    ),
    ...
    "ft-pythia-410m": ModelConfig(
        ...
        checkpoint_subdir="best/checkpoint-21476",
        is_learner_tuned=True,
        batch_size=8,
        gec_batch_size=32,
    ...
    "ft-pythia-1b": ModelConfig(
        ...
        checkpoint_subdir="best/checkpoint-21036",
        is_learner_tuned=True,
        batch_size=4,
        gec_batch_size=16,
        description="Pythia 1B fine-tuned on EFCAMDAT all-data",
    ),
    "pythia-1b-native": ModelConfig(
        name="pythia-1b-native",
        params="1B",
        ...
        batch_size=4,
        gec_batch_size=16,
        description="pythia-1b native (zero-shot baseline; matched control for ft-pythia-1b)",
    ),
    ...
    "ft-pythia-1.4b": ModelConfig(
        ...
        checkpoint_subdir="best/checkpoint-12278",
        is_learner_tuned=True,
        batch_size=2,
        gec_batch_size=16,
        description="Pythia 1.4B fine-tuned on EFCAMDAT all-data",
    ),
    "pythia-1.4b-native": ModelConfig(
        name="pythia-1.4b-native",
        params="1.4B",
        ...
        batch_size=2,
        gec_batch_size=16,
        description="pythia-1.4b native (zero-shot baseline; matched control for ft-pythia-1.4b)",
    ),
    ...
    "ft-smollm2-135m": ModelConfig(
        ...
        checkpoint_subdir="best/checkpoint-16289",
        is_learner_tuned=True,
        batch_size=16,
        gec_batch_size=32,
        description="SmolLM2 135M fine-tuned on EFCAMDAT all-data",
    ),
    "smollm2-135m-native": ModelConfig(
        name="smollm2-135m-native",
        params="135M",
        ...
        batch_size=16,
        gec_batch_size=32,
        description="smollm2-135m native (zero-shot baseline; matched control for ft-smollm2-135m)",
    ),
    ...
    "ft-smollm2-360m": ModelConfig(
        ...
        checkpoint_subdir="best/checkpoint-16712",
        is_learner_tuned=True,
        batch_size=8,
        gec_batch_size=32,
    ...
    "ft-smollm2-1.7b": ModelConfig(
        ...
        checkpoint_subdir="best/checkpoint-6688",
        is_learner_tuned=True,
        batch_size=2,
        gec_batch_size=16,
        description="SmolLM2 1.7B fine-tuned on EFCAMDAT all-data",
    ),
    "smollm2-1.7b-native": ModelConfig(
        name="smollm2-1.7b-native",
        params="1.7B",
        ...
        batch_size=2,
        gec_batch_size=16,
        description="smollm2-1.7b native (zero-shot baseline; matched control for ft-smollm2-1.7b)",
    ),

    "smollm2-360m-native": ModelConfig(
        name="smollm2-360m-native",
        params="360M",
        ...
        batch_size=8,
        gec_batch_size=32,
        description="SmolLM2 360M native (zero-shot baseline; matched control for ft-smollm2-360m)",
    ),
}
